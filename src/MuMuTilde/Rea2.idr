...
mutual 
  ...
  -- This suggests that: <λx.t|V.e> → <t[V/x]|e> for values V (this is witnessed by the fact that u is applied biorthT):
  ...
  --This suggests that when considering a context |u.e>, u has to be evaluated first: this is a call-by-value fashion. 
  --Given as a CPS translation, this would give: [u.e] f = [u]  (λV. f V [e]) 
    cut (reaR g d a u r s) (\vu => f (vu, reaL g d b pi r s))
  reaL g d a                (TyMuL c)     r s = \ia => 
    let r2 = extInt r $ biorthT ia in
    rea (extCtxt g a) d c r2 s
  reaL g d (Pos (Prod a b)) (TyPairL c)   r s = \(p,q) =>
  --This suggests that: <(t,u)|µ~(x,y).c> → c[t/x,u/y] for any t,u, this is a call-by-name fashion for the product type.
